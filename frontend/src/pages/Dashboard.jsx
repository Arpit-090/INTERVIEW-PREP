  ...
  return (
    <div className="max-w-6xl mx-auto">
      ...
      <div className="mb-8">
        ...
        <div> {/* profile button*/ }
          <button
          onClick={ handleprofile } className="bg-orange-500 text-white px-6 py-3 rounded-lg hover:bg-orange-600 transition cursor-pointer"> Profile </button>
          {/* logout button*/ }
          <button
          onClick={ handleDelete } className="bg-orange-500 text-white px-6 py-3 rounded-lg hover:bg-orange-600 transition cursor-pointer"> logout </button>
        </div>
